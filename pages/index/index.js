    ...
    if(options.channel){
        ...
        var channel=options.channel;
         ...
         setTimeout(()=>{
           ...
           my.uma.trackEvent('renwu_03',JSON.parse(myobj))
        },3000)
    }
    if(options.userid){
        //获取二维码参数
        ...
        this.login(options.userid);
            ...
            my.getAuthCode({
              ...
                 success: (result) => {
              //      console.log(result);
                  request('/api/v2/Login/GetAliUserSilent/GetAliUserSilent','GET',{auth_code:result.authCode,appid:'2021002129606766'}).then(res=>{
                    if(res.success){
